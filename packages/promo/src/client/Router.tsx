  ...
  public render() {
    return (
      <div>
        ...
        {/* 회원 */}
        <Route path="/about/members" component={About.Members} />
        {/* 파트너 목록 */}
        <Route path="/about/partners" component={About.Partners} />

        {/* 가입 안내 */}
        <Route exact path="/join" component={Join.Main} />
        {/* 가입 신청 */}
        ...
        {/* 소식 */}
        <Route path="/news" component={News.Main} />
        {/* 외부 행사 정보 */}
        <Route path="/news" component={News.Event} />
        {/* 보도자료 */}
